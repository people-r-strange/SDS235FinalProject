...
big_wildfires_weather <- filtered_weather_data %>% 
  filter(fire_size_class == "F" | fire_size_class == "G")
=======
big_wildfires <- filtered_weather_data %>% 
  filter(fire_size_class != "B" & fire_size_class != "C")
>>>>>>> 53191c3bf5852467906d7d2703f4d6cda7978a3b
```
...
=======
  labs(title = "Number of Fires >100 Acres Recorded Each Year", x = "Year", y = "Number of Fires") +
>>>>>>> 53191c3bf5852467906d7d2703f4d6cda7978a3b
  geom_smooth(method = "lm", se = F)
big_num_year_plot
```
...
=======
  labs(title = "Acreage Burned Per Year (From Wildfires >100 Acres)", x = "Year", y = "Number of Acres Burned")
>>>>>>> 53191c3bf5852467906d7d2703f4d6cda7978a3b
...
size_histogram <- ggplot(big_wildfires, aes(x = fire_size)) +
  ...
  facet_wrap(~year(disc_clean_date))
